...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.ReportingSettingsResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.ReportingSettingsRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/http.SiteResponse"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.SiteRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/http.SiteStatisticsResponse"
                            }
                        }
                    },
                    "500": {
        ...
        "/api/v1/subnets/{id}/usage-history": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "default": "7d",
                        "description": "Bounded history range",
                        "name": "range",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.SubnetUsageHistoryResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "http.ReportingSettingsResponse": {
            "type": "object",
            "properties": {
                "cadence": {
                    "type": "string",
        ...
        "http.SubnetUsageHistoryResponse": {
            "type": "object",
            "properties": {
                "cadence": {
                    "type": "string",
                ...
                "points": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.SubnetUsageSnapshotResponse"
                    }
                },
                "range": {
                    "type": "string",
        ...
        "http.SubnetUsageSnapshotResponse": {
            "type": "object",
            "properties": {
                "captured_at": {
                    "type": "string",
